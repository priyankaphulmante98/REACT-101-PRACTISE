...
```
 ...
 ✅ sshould change text in the button on toggle - 1marks
 ✅ should display fiction section by default - 1 marks
 ✅ should display all books in fiction section by default - 2 mark
 ✅ should display nonfiction book section text after toggling - 2 marks
